...
const assetsApi = 'https://api.github.com/repos/7719Drinkin/7719Drinkin.github.io/contents/assets/Basketball/MJ?ref=main';
const supportedImage = /\.(jpe?g|png|gif|webp)$/i;

const fallbackAssets = [
  "10196131834617797520.JPG",
  "10488980165229573680.JPG",
  "11349219704037530993.JPG",
  "11646838632284565940.JPG",
  "11775843438435290282.JPG",
  "11957335010598600622.JPG",
  "12114021349949282200.JPG",
  "1239998823771454063.JPG",
  "12772253911567008621.JPG",
  "12847381581561420996.JPG",
  "13107004743345770654.JPG",
  "13448986505012058779.JPG",
  "13662551537550473438.JPG",
  "13770826023627815810.JPG",
  "14460113893979216777.JPG",
  "15618924384798525331.JPG",
  "15815936170156050909.GIF",
  "15842363397869260745.JPG",
  "15942445778634938029.JPG",
  "16569224312694583431.JPG",
...
async function loadArchive() {
  try {
    ...
    renderArchive(fallbackAssets.map((name) => ({ name, url: `/assets/Basketball/MJ/${encodeURIComponent(name)}` })));
  }
}
