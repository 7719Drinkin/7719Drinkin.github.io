...
const WORLD_STYLES = {
  games: { seed: 77, relief: 0.68, palette: { low: '#102936', mid: '#1d4b5e', high: '#397a88', accent: '#73aeb0' } },
  music: { seed: 91, relief: 0.58, palette: { low: '#24172f', mid: '#43285a', high: '#76518a', accent: '#b183b4' } },
  anime: { seed: 118, relief: 0.52, palette: { low: '#171429', mid: '#49304f', high: '#a75b6d', accent: '#ffb0a4' } }
};
  ...
  return (
    <group>
      <mesh geometry={geometry}>
        <meshStandardMaterial vertexColors roughness={interest.id === 'games' ? 0.72 : 0.76} metalness={0.02} dithering />
      </mesh>
